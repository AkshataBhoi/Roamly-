  ...
  return (
    <main className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-5 md:px-8 py-8">
        ...
        {/* Image */}
        <div className="relative h-64 md:h-80 rounded-2xl overflow-hidden bg-muted mb-6">
        ...
        {/* Name & meta */}
        <h1
          className="text-[28px] font-semibold text-foreground leading-tight tracking-[-0.5px] mb-1"
          style={{ fontFamily: "var(--font-display)" }}
        >
          {place.name}
        </h1>
        <div className="flex items-center gap-2 text-[13px] text-muted-foreground mb-5">
          <span>
        ...
        <p className="text-[15px] text-foreground/80 leading-relaxed mb-8">
          {place.description}
        </p>

        <div className="space-y-5">
          {/* Why Roamly recommends */}
          <div className="bg-[#EAF3E8] border border-[#C8E0C4] rounded-xl p-5">
            <h2
            ...
            <p className="text-[14px] text-foreground/80 leading-relaxed">
              ...
              , this is one of the top picks for your current context.
            </p>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3">
          <button
            ...
            className={`flex-1 py-3 px-5 rounded-xl text-[14px] font-semibold transition-all flex items-center justify-center gap-2 cursor-pointer ${
              mapsClicked
          ...
          <button
            ...
            className={`flex-1 sm:flex-none sm:px-6 py-3 rounded-xl text-[14px] font-semibold border transition-colors flex items-center justify-center gap-2 cursor-pointer ${
              saved
